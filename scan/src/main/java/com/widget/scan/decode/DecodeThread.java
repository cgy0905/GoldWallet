...
public class DecodeThread extends AsyncTask<Void, Void, Result> {
	...
	private DecodeResultListener listener;
	private Bitmap mBitmap;
	private boolean isStop = false;

	public DecodeThread(LuminanceSource luminanceSource, DecodeResultListener listener) {
	...
	protected Result doInBackground(Void... params) {
		...
		hints.put(DecodeHintType.NEED_RESULT_POINT_CALLBACK, new ResultPointCallback(){
			...
			public void foundPossibleResultPoint(ResultPoint point) {
				listener.foundPossibleResultPoint(point);
			}
		});
