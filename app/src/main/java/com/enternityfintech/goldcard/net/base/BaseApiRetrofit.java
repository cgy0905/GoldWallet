package com.enternityfintech.goldcard.net.base;

import com.enternityfintech.goldcard.app.MyApp;
import com.enternityfintech.goldcard.utils.LogUtils;
import com.enternityfintech.goldcard.utils.NetUtils;
...
//                .addInterceptor(loggingInterceptor)//设置Debug Log模式
                .cache(cache)
                .build();
...
//                .addHeader("Cookie", "add cookies here")
    ...
    class LoggingInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            LogUtils.sf(String.format("发起请求 %s on %s%n%s", request.url(), chain.connection(),request.headers()));
