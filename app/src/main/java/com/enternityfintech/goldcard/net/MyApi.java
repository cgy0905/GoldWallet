package com.enternityfintech.goldcard.net;
...
public interface MyApi {
    public static final String BASE_URL = "http://192.168.108.100:28890/hsd-account-actor-web-portal/api/";
    ...
    //登录发送验证码
    @POST("account/actor/sign/login/sms")
    Observable<LoginResponse> sendCode(@Body RequestBody body);
